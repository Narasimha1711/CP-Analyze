  ...
  return (
    <>
      ...
      <div>
        ...
        <div  style={{width: '600px', height: '300px'}} className='flex justify-center w-11/12 h-96 mx-auto my-7'>
      ...
      <div style={{width: '500px', height: '600px'}} className='flex justify-center w-11/12 h-96 mx-auto my-10'>
        ...
        { data1 ? <CfGraph /> : <div className='text-center my-6'>Handle is not submitted</div>}
