...
// import Donutchartdifficulty from './Donutchartdifficulty'
import LeetcodeGraph from './LeetGraph';
...
function Leetcode() {
  ...
  {d ?<LeetcodeGraph /> : <div className='text-center my-6'>Handle is not submitted</div>}
